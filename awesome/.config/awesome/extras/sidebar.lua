...
-- XXX width and height are reversed
...
local temperature_bar = require("extras.temperature_bar")
...
local battery_bar = require("extras.battery_bar")
...
local cpu_bar = require("extras.cpu_bar")
...
local ram_bar = require("extras.ram_bar")
...
day_of_the_week.font = "Terminus italic 20"
...
day_of_the_month.font = "Terminus 20"
...
local disk_space = require("extras.disk")
...
local volume_bar = require("extras.volume_bar")
